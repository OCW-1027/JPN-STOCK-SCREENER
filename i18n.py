...
RANK_UI = {
    "ko": dict(
        ...
        lead="매 영업일 거래대금 상위 100위의 순위 변화 (위쪽이 상위)",
        days="일", rank_unit="위",
        col_rank="순위", col_code="코드", col_name="종목명",
        col_delta="전일대비", col_value="거래대금", col_best="최고순위",
        new_in="신규",
        markets=dict(jp="🇯🇵 일본", kr="🇰🇷 한국", us="🇺🇸 미국"),
        acc_title="데이터 축적 중입니다 (현재 {n}일)",
    ...
    "ja": dict(
        ...
        lead="各営業日の売買代金 上位100位の順位変化（上が上位）",
        days="日", rank_unit="位",
        col_rank="順位", col_code="コード", col_name="銘柄名",
        col_delta="前日比", col_value="売買代金", col_best="最高順位",
        new_in="新規",
        markets=dict(jp="🇯🇵 日本", kr="🇰🇷 韓国", us="🇺🇸 米国"),
        acc_title="データ蓄積中です（現在 {n}日）",
