...
UI = {
    "ko": dict(
        ...
        c_inst_d="기관연속", c_inst5="기관5일", c_indi5="개인5일", c_mratio="대차배율", c_mdays="신용부담일", c_mbuychg="신용매수Δ", c_spct="기관공매도%", c_schg="공매도Δ",
    ...
    "ja": dict(
        ...
        c_inst_d="機関連続", c_inst5="機関5日", c_indi5="個人5日", c_mratio="貸借倍率", c_mdays="信用負担日", c_mbuychg="信用買Δ", c_spct="機関空売り%", c_schg="空売りΔ",
...
HELP = {
    ...
    "c_spct": ("발행주식 0.5% 이상 숏 포지션을 보유한 기관들의 합산 잔고 비율 (JPX 일별 공시). 비어 있으면 해당 기관 없음.",
               "発行株式0.5%以上のショートを持つ機関の合算残高比率(JPX日次開示)。空欄は該当機関なし。"),
