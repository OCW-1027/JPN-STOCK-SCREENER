...
UI = {
    "ko": dict(
        ...
        c_cleared="청산", c_mratio="대차배율", c_mdays="신용부담일", c_mbuychg="신용매수Δ", c_spct="기관공매도%", c_schg="공매도Δ",
    ...
    "ja": dict(
        ...
        c_cleared="清算", c_mratio="貸借倍率", c_mdays="信用負担日", c_mbuychg="信用買Δ", c_spct="機関空売り%", c_schg="空売りΔ",
